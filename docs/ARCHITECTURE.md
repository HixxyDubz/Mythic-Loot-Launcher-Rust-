...
- `components/`: title bar, modpack navigation, dashboard, Activity Centre, Storage, settings, Developer publisher, Smart Launch, Safe Launch and staged update/repair workspaces.
